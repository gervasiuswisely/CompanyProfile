    ...
    <!-- <div class="info d-flex align-items-center"> -->
      <!-- <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center"> -->
            <!-- <a href=""><h2 data-aos="fade-down" class="1">Welcome To PT Marga Yasa Konstruksi Indonesia one of the Roof Applicator in Indonesia <span></span></h2> 
     ...
     <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        foreach ($data as $value){
            ?>
       <div class="carousel-item active"  style="background-image: url(assets/img/foto-projek-dan-produk-myki/<?php echo $value['slide1']?>)">
       <div class="carousel-caption d-none d-md-block">
         <h5>Student Center Atmajaya</h5>
         <p></p>
       </div>
       </div>
       <div class="carousel-item" style="background-image: url(assets/img/foto-projek-dan-produk-myki/<?php echo $value['slide2']?>)">
         <div class="carousel-caption d-none d-md-block">
           <h5></h5>
           <p></p>
         </div>
       </div>
       <div class="carousel-item" style="background-image: url(assets/img/foto-projek-dan-produk-myki/<?php echo $value['slide3']?>)">
         <div class="carousel-caption d-none d-md-block">
           <h5></h5>
           <p></p>
         </div>
       ...
       <!-- <div class="carousel-item" style="background-image: url(assets/img/foto-projek-dan-produk-myki/dankos\ pharma.jpg)">
         <div class="carousel-caption d-none d-md-block">
           <h5></h5>
           <p></p>
         </div>
       </div>
       <div class="carousel-item" style="background-image: url(assets/img/foto-projek-dan-produk-myki/mondelez.jpg)">
       <div class="carousel-caption d-none d-md-block">
         <h5></h5>
         <p></p>
       </div>
