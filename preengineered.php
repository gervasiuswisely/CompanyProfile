...
<!--                 -->
          ...
          <li><a href="preengineered.php?lang=idn"><img class="logoindo" src="assets/img/icon/indonesia.png" alt=""></a></li>
          <li><a href="preengineered.php?lang=en"><img class="logoeng" src="assets/img/icon/united-kingdom.png" alt=""></a></li>
      </nav><!-- .navbar -->
  ...
  <main id="main">
    ...
    <!-- ======= Services Section ======= -->
          ...
          <section id="preengineered" class="preenginereed2">
          <div class="container-fluid">
        <div class="container-lg container-fluid-md  services1">
          <div class="row">
          <h1><?php echo $lang ['preenginereed']?></h1>
              <p><?php echo $lang ['prep']?></p>
          <div class="img">
          <img src="assets/img/our-services/pre-enginereed-buildingresize.png" alt="">
          </div>
          <ul>
