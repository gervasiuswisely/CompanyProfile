...
<!--                 -->
          ...
          <li class="dropdown active"><a href="#" ><span><?php echo $lang ['eproc']?></span> </i></a>
              <ul>
          ...
          <li><a href="login.php?lang=idn"><img class="logoindo" src="assets/img/icon/indonesia.png" alt=""></a></li>
          <li><a href="login.php?lang=en"><img class="logoeng" src="assets/img/icon/united-kingdom.png" alt=""></a></li>
      </nav><!-- .navbar -->
      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card  shadow-2-strong" style="border-radius: 1rem;">
          ...
          <div class="d-flex justify-content-center align-items-center">
            <h1><?php echo $lang ['mykilogin']?></h1></center>
          </div>
            <div class="row formlogin2">
             <div class="form-outline mb-4">
                <div class="mb-3">
                     <label for="exampleInputEmail1" class="form-label"><?php echo $lang ['email-login']?></label>
                    <input type="email" name="emailmyki" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div  class="mb-3">
                    <label for="exampleInputPassword1" class="form-label"><?php echo $lang ['password']?></label>
                    <input type="password" name="passwordmyki" class="form-control" id="exampleInputPassword1">
            </div>
            <div class="form-check d-flex justify-content-start mb-4">
              <input class="form-check-input" type="checkbox" value="" id="form1Example3" />
              <label class="form-check-label" for="form1Example3" name="remembermemyki">  <?php echo $lang ['remember-login']?> </label>
              
            </div>
            <p class="donthaveaccount"><?php echo $lang ['dont']?>?<a href="register.php"><?php echo $lang ['registerhere']?></a></p>
            </div>
          


                        </div>
                          <center><button class="loginvendor2" name="loginmyki" type="submit" ><?php echo $lang ['login']?></button></center>
                    </div>
                </div>
            </div>
    </div>
