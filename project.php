...
$ambildata = $pdo->query("SELECT count(*) FROM project where judul LIKE '%$cari%' OR client LIKE '%$cari%'")->fetchColumn();
$jumlahdata=6;
$totaldata=$ambildata;
...
$ambildataperhalaman=$pdo->query("SELECT *from project where judul LIKE '%$cari%' OR client LIKE '%$cari%' limit $dataawal,$jumlahdata ");
$ambildataperhalaman->execute();
$data=$ambildataperhalaman->fetchAll();
          ...
          <?php
            ...
            <div class="cardproject" style="width: 100%;">
                ...
                <div class="portfolio-content">
                  <a href="projectdetails.php?project_name=<?php echo $value['judul']?>"> <img class="img-fluid" src="assets/img/foto-projek-dan-produk-myki/<?php echo $value['image_path']?>"> </a>
