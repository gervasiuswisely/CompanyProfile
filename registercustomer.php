...
<!--                 -->
          ...
          <li><a href="registercustomer.php?lang=idn"><img class="logoindo" src="assets/img/icon/indonesia.png" alt=""></a></li>
          <li><a href="registercustomer.php?lang=en"><img class="logoeng" src="assets/img/icon/united-kingdom.png" alt=""></a></li>
      </nav><!-- .navbar -->
  ...
  <div class="container-fluid reqcustomer">
    <div class="container-lg  container-md-fluid containercustomer">
      <h1><?php echo $lang ['formregistercustomer']?></h1>
      <form action="" method="post">
        <div class="row">
          ...
          <label for="alamat"><?php echo $lang ['alamat']?></label>
            ...
            <br>
            <br>
            <button class="project" type="submit" name="registercustomer"><?php echo $lang ['register']?></button>
          </div>
