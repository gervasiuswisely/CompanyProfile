...
$ambildataperhalaman=$pdo->query("SELECT *from project where project_id LIKE '%$cari%' OR judul LIKE '%$cari%' OR client LIKE '%$cari%' order by project_id limit $dataawal,$jumlahdata ");
...
<section>
  ...
  <thead>
    <tr>
      <th scope="col"><?php echo $lang ['project_id']?></th>
      <th scope="col"><?php echo $lang ['judul_projek']?></th>
      <th scope="col"><?php echo $lang ['client_projek']?></th>
      <th scope="col"><?php echo $lang ['tahun_projek']?></th>
      <th scope="col"><?php echo $lang ['alamat_projek']?></th>
      <th scope="col"><?php echo $lang ['image_path_projek']?></th>
  ...
  <tbody>
    ...
    <td><a href="hapusprojek.php?project_id=<?php echo $value['project_id'];?>">Hapus</a> /  <a href="formeditprojek.php?project_id=<?php echo $value['project_id'];?>">Edit</a></td>
    <?php
