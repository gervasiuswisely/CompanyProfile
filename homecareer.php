...
$ambildataperhalaman=$pdo->query("SELECT *from lowongan_kerja where job_id LIKE '%$cari%' OR job_name LIKE '%$cari%' OR education LIKE '%$cari%' OR year_experience LIKE '%$cari%' OR kriteria_umum LIKE '%$cari%' OR deskripsi_umum LIKE '%$cari%' order by job_id limit $dataawal,$jumlahdata ");
$ambildataperhalaman->execute();
$data=$ambildataperhalaman->fetchAll();

$namauser=$_SESSION['namauser'];

$ambildatapegawai=$pdo->query("SELECT *from employee where nama='$namauser'");
$ambildatapegawai->execute();
$datapegawai=$ambildatapegawai->fetchAll();
...
<!--                 -->
          ...
          <li><a href="profilecareer.php?nama=<?php echo $namauser?>" class="active"><?php echo $namauser?></a></li>
          <li><a href="logoutcareer.php">LOGOUT</a></li>
...
<section>
    <div class="container-fluid career2">
        <div class="container-lg container-fluid-md">
            <div class="row">
                <div class="col-12">
                <h1> Welcome <a href="profilecareer.php"><?php echo $namauser?></a> To MYKI</h1>
                <h1><?php echo $lang['posisi']?></h1>
                <form method="post" action="careerori2.php">
  ...
  <tbody>
    <tr>
      <td><a href="careerdetails.php?job_id=<?php echo $value['job_id']?>&job_position=<?php echo $value['job_name'];?>"><?php echo $value['job_id']?></td>
