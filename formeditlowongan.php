...
$jobid=$_GET['job_id'];
$query=$pdo->query("select * from lowongan_kerja where job_id='$jobid' ");
$query->execute();
$data=$query->fetchAll();
...
<form action="editlowongan.php?job_id=<?php echo $value['job_id']?>" method="post">
<div class="container-fluid ">
        ...
        <div class="row ">
            <div class="col-6">
              ...
              <label for="jobid"> Job id</label>
                <br>
                <input class="jobid" name="jobid" type="text" value="<?php echo $value['job_id'];?>" >
                <br>
                <label for="jobposition">Posisi</label>
                <br>
                <input type="text" class="jobposition" name="jobposition" value="<?php echo $value['job_name'];?>">
                <br>
                <label for="pendidikan"> Pendidikan </label>
                <input type="text" class="pendidikan" name="pendidikan" value="<?php echo $value['education'];?>">
                <br>
                <label for="pengalamankerja"> Pengalaman Kerja</label>
                <br>
                <input type="text" class="pengalamankerja" name="pengalamankerja"value="<?php echo $value['year_experience'];?>">
                <br>
                <label for="kriteriaumum"> Kriteria Umum</label>
                <br>
                <input type="text" class="kriteriaumum" name="kriteriaumum"value="<?php echo $value['kriteria_umum'];?>">
                <br>
                <label for="deskripsiumum">Deskripsi Umum</label>
                <br>
                <input type="text" class="deskripsi" name="deskripsi" value="<?php echo $value['deskripsi_umum'];?>">
                <br>
                <label for="pekerjaan">Pekerjaan</label>
                <br>
                <input type="text" class="pekerjaan" name="pekerjaan"value="<?php echo $value['job_desc'];?>">
                <br>
                <label for="kriteria">Kriteria</label>
                <br>
                <input type="text" class="kriteria" name="kriteria"value="<?php echo $value['job_criteria'];?>">
            </div>
            <div class="col-6 col2">
                <label for="salarymin"> Salary Minimal </label>
                <br>
                <input class="salarymin" name="salarymin" type="text"value="<?php echo $value['salary_min'];?>">
                <br>
                <label for="salarymax"> Salary Maksimal</label>
                <br>
                <input class="salarymax" name="salarymax" type="text"value="<?php echo $value['salary_max'];?>">
                <br>
                <label for="jobstatus"> Job Status </label>
                <br>
                <input class="jobstatus" name="jobstatus" type="text"value="<?php echo $value['job_status'];?>">
                <br>
                <label for="jobdes"> Job Deskripsi (EN) </label>
                <br> 
                <input class="jobdescen" name="jobdes" type="text"value="<?php echo $value['jobdescen'];?>">
                <br>
                <label for="jobcriteriaen" class="jobcriteriaen"> Job Kriteria (EN) </label>
                <br> 
                <input type="text" class="jobcriteriaen" name="jobcriteriaen"value="<?php echo $value['jobcriteriaen'];?>">
                <br>
                <label for="educationen" class="educationen"> Pendidikan (EN) </label>
                <br> 
                <input type="text" class="educationen" name="educationen"value="<?php echo $value['educationen'];?>">
            </div>
  ...
  <button  type="submit" name="updatelamaran"><?php echo $lang ['apply']?></button>
