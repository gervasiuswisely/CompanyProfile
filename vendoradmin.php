...
$ambildata = $pdo->query("SELECT count(*) FROM supplyrequest")->fetchColumn();
$jumlahdata=4;
$totaldata=$ambildata;
...
$ambildataperhalaman=$pdo->query("SELECT *from supplyrequest  order by id limit $dataawal,$jumlahdata ");
...
<section>
  ...
  <tbody>
    ...
    <td><a href="approvesupply.php?supply_id=<?php echo $value['id'];?>">Approve</a> /  <a href="rejectsupply.php?supply_id=<?php echo $value['id'];?>">Reject</a></td>
    <?php
