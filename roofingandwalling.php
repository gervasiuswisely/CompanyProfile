...
<!--                 -->
          ...
          <li><a href="roofingandwalling.php?lang=idn"><img class="logoindo" src="assets/img/icon/indonesia.png" alt=""></a></li>
          <li><a href="roofingandwalling.php?lang=en"><img class="logoeng" src="assets/img/icon/united-kingdom.png" alt=""></a></li>
      </nav><!-- .navbar -->
  ...
  <main id="main">
    ...
    <!-- ======= Services Section ======= -->
    <section class="services1section">
      <div class="container-fluid">
        <div class="container-lg container-fluid-md services1 ">
          <div class="row">
          <h1><?php echo $lang ['roof']?></h1>
          <p><?php echo $lang ['roofp']?> </p>
          <div class="img">
          <img src="assets/img/our-services/roof-installation.jpeg" alt="">
          </div>
          <ul>
