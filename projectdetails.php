...
$query=$pdo->query("select * from project where judul='$project_name'");
...
<head>
  ...
  <title><?php echo $value['judul']?></title>
...
<!--                 -->
          ...
          <li><a href="projectdetails.php?project_id=<?php echo $project_id?>&lang=idn"><img class="logoindo" src="assets/img/icon/indonesia.png" alt=""></a></li>
          <li><a href="projectdetails.php?project_id=<?php echo $project_id?>&lang=en"><img class="logoeng" src="assets/img/icon/united-kingdom.png" alt=""></a></li>
      </nav><!-- .navbar -->
    ...
    <section id="projects" class="projects">
      ...
      <div class="row gy-4 " >
          <?php
            ...
            ?>
            <div class="col-lg-6 portfolio-item filter-remodeling ">
              <div class="portfolio-content-details h-100">
                <img   class="img-details " src="assets/img/foto-projek-dan-produk-myki/<?php echo $value['image_path']?>" >
            </div>
            </div>
                <div class="col-lg-6  judul">
                <li><?php echo $lang ['judul2']?> <?php echo ' ' ?> :  <?php echo ' ' ?><?php echo $value['judul']?></li>
                <li><?php echo $lang ['klien']?> <?php echo ' ' ?> : <?php echo ' ' ?> <?php echo $value['client']?></li>
                <li><?php echo $lang ['lokasi']?> <?php echo ' ' ?> : <?php echo $value['lokasi']?></li>
                <li><?php echo $lang ['tahun']?> <?php echo ' ' ?> : <?php echo $value['tahun']?></li>
                <br>
                <div class="d-grid gap-2 d-md-block">
                <button class="btn btn-primary" type="button"><a href="project.php"><?php echo $lang ['back']?></button></a>
                </div>
