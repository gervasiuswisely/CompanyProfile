...
$ambildata = $pdo->query("SELECT count(*) FROM lowongan_kerja  where job_id LIKE '%$cari%' OR job_name LIKE '%$cari%' OR education LIKE '%$cari%' OR year_experience LIKE '%$cari%' OR kriteria_umum LIKE '%$cari%' OR deskripsi_umum LIKE '%$cari%'  ")->fetchColumn();
$jumlahdata=5;
$totaldata=$ambildata;
...
<section>
  ...
  <tbody>
    <tr>
      <td><a href="careerdetails.php?job_position=<?php echo $value['job_name']?>" style="color:grey;opacity=10%"><?php echo $value['job_id']?></td>
...
<?php if($halamanaktif >1):?>
    ...
    for ($i=$startnumber;$i<=$endnumber;$i++){
       ...
       <?php if($halamanaktif==$i):
        ?>
        <a href="?halaman=<?php echo $i; ?>" style="background-color:red;color:white;font-weight:bold; "><?php echo $i;?></a>
