...
$ambildata = $pdo->query("SELECT count(*) FROM lamaran_")->fetchColumn();
$jumlahdata=5;
$totaldata=$ambildata;
...
$datapegawai=$ambildataperhalaman->fetchAll();

$namauser=$_SESSION['namauser'];

$ambildatapegawai=$pdo->query("SELECT *from lamaran_ ");
...
<section>
  ...
  <tbody>
    <tr>
      <td><a href="lamarandetails.php?employee_id=<?php echo $value['lamaran_id']?>"><?php echo $value['lamaran_id']?></td>
      <td><?php echo $value['job_id']?></td>
    <td><?php echo $value['job_name']?></td>
    <td><?php echo $value['employee_id']?></td>
    <td><?php echo $value['nama']?></td>
    <td><?php echo $value['status']?></td>
    <td><a href="approvelamaran.php?lamaran_id=<?php echo $value['lamaran_id']?>">Approve</a>
              /
        <a href="rejectlamaran.php?lamaran_id=<?php echo $value['lamaran_id']?>">Reject</a>
</td>
    <?php
