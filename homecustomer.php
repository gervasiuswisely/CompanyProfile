...
$query=$pdo->query("select * from client where client_name='$namacustomer'");
$query->execute();
$datacustomer=$query->fetchAll();
...
$ambildata = $pdo->query("SELECT count(*) FROM projectrequest where client_name='$namacustomer'")->fetchColumn();
$jumlahdata=4;
$totaldata=$ambildata;
...
$ambildataperhalaman=$pdo->query("SELECT *from projectrequest where client_name='$namacustomer' order by id limit $dataawal,$jumlahdata ");
...
<!--                 -->
          ...
          <li class="dropdown"><a href="#" ><span><?php echo $lang ['eproc']?></span> </i></a>
              <ul>
                <li><a href="#">Vendor / Subcon </a></li>
                <li><a href="#">Customer </a></li>
              </ul>
          </li>
          <li><a href="contactus.php"><?php echo $lang['kontak']?></a></li>
          <li><a href="#" class="active"><?php echo $namacustomer?></a></li>
          <li><a href="logout.php">LOGOUT</a></li>
          <li><a href="projectadmin.php?lang=idn"><img class="logoindo" src="assets/img/icon/indonesia.png" alt=""></a></li>
          <li><a href="projectadmin.php?lang=en"><img class="logoeng" src="assets/img/icon/united-kingdom.png" alt=""></a></li>
...
<section>
    <div class="container-fluid career2">
        <div class="container-lg container-fluid-md">
            <div class="row">
                <div class="col-12">
                <h1>Daftar Supply</h1>
                <a href="customer2.php?client_id=<?php echo $customer['client_id']?>">Tambah</a>
                <br>
                Welcome Customer MYKI  <a href="addprojek.php"><?php echo $namacustomer?></a>
                <form method="post" action="projectadmin.php">
                <div class="input-group rounded search2">
                <input type="text" class="form-control rounded" name='cari' placeholder="Judul" aria-label="Search" aria-describedby="search-addon"  ?> 
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Build Of Quantity</th>
  ...
  <tbody>
    ...
    <td><?php echo $value['build_of_quantity']?></td>
    <td><?php echo $value['status']?></td>

    <?php
      $_SESSION["project_id"] = $value["project_id"];
    ?>
    </tr>
  </tbody>
  <?php
