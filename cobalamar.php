...
$ambildata = $pdo->query("SELECT count(*) FROM lamaran")->fetchColumn();
$jumlahdata=5;
$totaldata=$ambildata;
...
$ambildataperhalaman=$pdo->query("SELECT * FROM lamaran  l JOIN employee e on l.employee_Id = e.employee_id join job j on j.job_id = l.job_id  limit $dataawal,$jumlahdata ");
...
<section>
        ...
        <div class="container-lg container-fluid-md">
            <div class="row">
               ...
               <h1><a href="profiledetails.php">Profile <?php echo $namauser?></h1></a>
                <div class="profileimage img-fluid">
                    <img src="./assets/img/c14180118.png" alt="">
                </div>
  ...
  <tbody>
    <tr>
      <td><a href="careerdetails.php?job_id=<?php echo $value['id_lamaran']?>"><?php echo $value['id_lamaran']?></td>
