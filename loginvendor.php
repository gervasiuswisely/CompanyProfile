...
<!--                 -->
          ...
          <li class="dropdown active"><a href="#" class="active"><span><?php echo $lang ['eproc']?></span> </i></a>
              <ul>
          ...
          <li><a href="loginvendor.php?lang=idn"><img class="logoindo" src="assets/img/icon/indonesia.png" alt=""></a></li>
          <li><a href="loginvendor.php?lang=en"><img class="logoeng" src="assets/img/icon/united-kingdom.png" alt=""></a></li>
      </nav><!-- .navbar -->
      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card  shadow-2-strong" style="border-radius: 1rem;">
          ...
          <div class="d-flex justify-content-center align-items-center">
            <h1><?php echo $lang ['vendorlogin']?></h1></center>
          </div>
            ...
            <div class="form-check d-flex justify-content-start mb-4">
              ...
              <label class="form-check-label" for="form1Example3" name="remembermevendor">  <?php echo $lang ['remember-login']?> </label>
              
            </div>
            <p class="donthaveaccount"><?php echo $lang ['dont']?>?<a href="registervendor.php"><?php echo $lang ['registerhere']?></a></p>
            </div>
          


                        </div>
                          <center><button class="loginvendor2" name="loginvendor" type="submit" ><?php echo $lang ['login']?></button></center>
                    </div>
                </div>
            </div>
    </div>
