...
$ambildata = $pdo->query("SELECT count(*) FROM projectrequest")->fetchColumn();
$jumlahdata=4;
$totaldata=$ambildata;
...
$ambildataperhalaman=$pdo->query("SELECT *from projectrequest  order by id limit $dataawal,$jumlahdata ");
...
<!--                 -->
          ...
          <li class="dropdown"><a href="#"class="active"><span><?php echo $lang ['eproc']?></span> </i></a>
              <ul>
          ...
          <li><a href="vendoradmin.php?lang=idn"><img class="logoindo" src="assets/img/icon/indonesia.png" alt=""></a></li>
          <li><a href="vendoradmin.php?lang=en"><img class="logoeng" src="assets/img/icon/united-kingdom.png" alt=""></a></li>
...
<section>
  ...
  <tbody>
    ...
    <td><a href="approveproject.php?project_id=<?php echo $value['id'];?>">Approve</a> /  <a href="rejectproject.php?project_id=<?php echo $value['id'];?>">Reject</a></td>
    <?php
