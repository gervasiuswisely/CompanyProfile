...
$query=$pdo->query("select * from vendor where nama='$namavendor'");
$query->execute();
$datavendor=$query->fetchAll();
foreach($datavendor as $vendor){

}
$ambildata = $pdo->query("SELECT count(*) FROM supplyrequest  where supplier_name='$namavendor'")->fetchColumn();
$jumlahdata=4;
$totaldata=$ambildata;
...
$ambildataperhalaman=$pdo->query("SELECT *from supplyrequest where supplier_name='$namavendor' order by id limit $dataawal,$jumlahdata ");
...
<!--                 -->
          ...
          <li><a href="#" class="active"><?php echo $namavendor?></a></li>
...
<section>
    <div class="container-fluid career2">
        <div class="container-lg container-fluid-md">
            <div class="row">
                <div class="col-12">
                <h1>Daftar Supply</h1>
                <a href="vendor2.php?vendor_id=<?php echo $vendor['vendor_id']?>">Tambah</a>
                <br>
                <h1>Welcome Supplier MYKI  <?php echo $namavendor?></h1>
                <form method="post" action="homevendor.php">
  ...
  <tbody>
    ...
    <td><?php echo $value['minimum_order']?></td>
