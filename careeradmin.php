...
<section>
    <div class="container-fluid career2">
        <div class="container-lg container-fluid-md">
            <div class="row">
                ...
                <a href="formlowongan.php">Tambah</a>
                <br>
                <a href="lamaranadmin.php">View Lamaran</a>
  ...
  <tbody>
    ...
    <td><a href="hapuslowongan.php?job_id=<?php echo $value['job_id'];?>">Hapus</a> /  <a href="formeditlowongan.php?job_id=<?php echo $value['job_id'];?>">Edit</a></td>
