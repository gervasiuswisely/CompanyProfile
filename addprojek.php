...
<div class="container-fluid ">
    <div class="container-lg container-md-fluid lamaran3container">
        <div class="row ">
            <div class="col-6">
              ...
              <label for="projectid"> Project id</label>
                <br>
                <input class="projectid" name="projectid" type="text">
                <br>
                <label for="projectjudul">Judul</label>
                <br>
                <input type="text" class="projectjudul" name="projectjudul">
                <br>
                <label for="projectclient"> Client </label>
                <br>
                <input type="text" class="projectclient" name="projectclient">
                <br>
                <label for="lokasi"> lokasi</label>
                <br>
                <input type="text" class="lokasi" name="lokasi">
                <br>
                <label for="projecttahun"> Tahun</label>
                <br>
                <input type="text" class="projecttahun" name="projecttahun">
                <br>
                <label for="projectimagepath">Image Path</label>
                <br>
                <input type="text" class="projectimagepath" name="projectimagepath">
                <br>
            </div>
        ...
        <div class="row">
            <div class="col">
  <button  type="submit" name="tambahprojek"><?php echo $lang ['apply']?></button>
</div>\<div class="">
