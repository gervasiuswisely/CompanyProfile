...
<!--                 -->
          ...
          <li><a href="pavment.php?lang=idn"><img class="logoindo" src="assets/img/icon/indonesia.png" alt=""></a></li>
          <li><a href="pavment.php?lang=en"><img class="logoeng" src="assets/img/icon/united-kingdom.png" alt=""></a></li>
      </nav><!-- .navbar -->
  ...
  <main id="main">
    ...
    <!-- ======= Services Section ======= -->
        ...
        <div class="container-lg container-fluid-md  services1">
          <div class="row">
          <h1><?php echo $lang ['pavment']?></h1>
              <p><?php echo $lang ['pavmentp']?> </p>
          <div class="img">
          <img src="assets/img/our-services/pavement (1).png" alt="">
          </div>
          <ul>
