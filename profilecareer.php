...
$ambildata = $pdo->query("SELECT count(*) FROM lamaran_ where nama='$namauser'")->fetchColumn();
$jumlahdata=5;
$totaldata=$ambildata;
...
$ambildataperhalaman=$pdo->query("SELECT *from lamaran_ order by lamaran_id limit $dataawal,$jumlahdata ");
$ambildataperhalaman->execute();
$data=$ambildataperhalaman->fetchAll();

$namauser=$_SESSION['namauser'];

$ambildatapegawai=$pdo->query("SELECT *from lamaran_ l join employee e on l.employee_id = e. employee_id join lowongan_kerja j on j.job_id=l.job_id where l.nama ='$namauser'");
...
<section>
    <div class="container-fluid career2">
        <div class="container-lg container-fluid-md">
            <div class="row">
                <div class="col-12">
               <h1><a href="profiledetails.php">Profile <?php echo $namauser?></h1></a>
                <div class="profileimage " >
                    <img src="./assets/img/c14180118.png" class="img-fluid" alt="profilepicture">
                </div>
                <h1>Daftar Lamaran kerja </h1>
                <form method="post" action="profilecareer.php">
  ...
  <tbody>
    <tr>
      <td><a href="lamarandetails.php?lamaran_id=<?php echo $value['lamaran_id']?>"><?php echo $value['lamaran_id']?></td>
