...
<!--                 -->
          ...
          <li><a href="registervendor.php?lang=idn"><img class="logoindo" src="assets/img/icon/indonesia.png" alt=""></a></li>
          <li><a href="registervendor.php?lang=en"><img class="logoeng" src="assets/img/icon/united-kingdom.png" alt=""></a></li>
      </nav><!-- .navbar -->

    </div>
</header>
  <section class="headervendor2">
  <div class="container-fluid supply">
    <div class="container-lg container-md-fluid containervendor">
      <h1><?php echo $lang ['formregistervendor']?></h1>
      <form action="" method="post">
        <div class="row vendorrow">
          <div class="col-6">
            <label for="nama"><?php echo $lang ['nama-register']?></label>
            <br>
            <input type="text" name="nama">
            <br>
            <label for="badanusaha"><?php echo $lang ['jenisbadan']?></label>
            <br>
            <input type="text" name="badanusaha">
            <br>
          ...
          <label for="website"><?php echo $lang ['website']?></label>
            ...
            <br>
            <br>
            <button class="registervendor" name="registervendor"><?php echo $lang ['register']?></button>
