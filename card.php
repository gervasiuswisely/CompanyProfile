...
<div class="cardproject" style="width: 18rem;">
  <img src="./assets/img/foto-projek-dan-produk-myki/bayerdepok.jpeg" class="card-img-top" alt="...">
  <div class="card-bodyproject">
    <p class="card-textproject">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
  </div>
</div>
